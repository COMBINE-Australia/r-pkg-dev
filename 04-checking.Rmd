...
You can see all the different types of checks that **devtools** has run but
they most important section is at the end where it tells you how many errors,
warnings and notes there are. Often these come with hints about how to fix them
but sometimes they can be hard to understand. If you are not sure what they
mean try doing an internet search and it is likely that somebody else has come
across the same problem. Our package has received one warning telling us that we
