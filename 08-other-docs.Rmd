...
using `?mypkg`. The information here has been automatically pull from the
...
difference functions can be used together. There are different ways to write
...
If you are familiar with R Markdown you might not some unusual content in the
