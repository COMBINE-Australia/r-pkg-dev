...
to see what those look like. Before is a new function called `plot_colours()`
...
The two lines at bottom tells us that our package uses functions in
...
use them. The output of `usethis::use_package()` with give you an example if
...
Hopefully that we have imported **ggplot2** we should pass the checks.
