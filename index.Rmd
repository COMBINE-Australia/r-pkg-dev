...
The materials were written using the **bookdown** package [@R-bookdown], which
is built on top of R Markdown and **knitr** [@xie2015].
...
The packages used in the workshop are below with the versions used in these
materials:
...
```{r}
pkgs <- c("devtools", "usethis", "roxygen2", "testhat", "knitr")
